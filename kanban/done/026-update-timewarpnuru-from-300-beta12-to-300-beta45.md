...
### Changes Made
- Updated `Directory.Packages.props`: TimeWarp.Nuru 3.0.0-beta.12 → 3.0.0-beta.45
...
- Same failure count as before the update
...
- TimeWarp.Nuru.Parsing and TimeWarp.Nuru.Analyzers continue to work with $(Version) variable

### Files Changed
- `Directory.Packages.props` - Line 20: Version updated to 3.0.0-beta.45
